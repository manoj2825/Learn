...
//
//	// --- data
//	WriteData(pszTitle, pscdm, 0, (long)0);
//
//	// --- data (each)
...
////
//// outline
////      指定されたUserSetting情報を指定のインデックスでレジストリに
////      書き込む
////=============================================================================
//long CShJsonUS::WriteData(WCHAR FAR *pszTitle, PSCDM pscdm, long lIndex, BOOL blOverWrite, WCHAR FAR *pszTime, BOOL bSelf)
//{
//	long			lRet = -1;
//
//	long			lCount = 0;
...
//		dwID = SearchUnusedID();
//
//	lRet = WriteData(pszTitle, pscdm, lIndex, (long)dwID, pszTime, bSelf);
//	if(lRet != -1)
//		WriteEachData(pscdm, (long)dwID);
//
//	long lRetReg = -1;
//
...
//	BOOL			blRet = FALSE;
//
//	blRet = WriteJsonDWORDData(JSON_KEY_US_ROOT_BASE, JSON_ENT_US_COUNT, dwCount);
//		
//	blRet = TRUE;
//
//	return blRet;
...
////
//// outline
////      指定されたインデックスのUserSetting情報をレジストリから読み込む
////=============================================================================
...
//	
//	// --- count
//	blSuccess = ReadJsonDWORDData(JSON_KEY_US_ROOT_BASE, JSON_ENT_US_COUNT, dwData);
//
//	return dwData;
//}
//
...
//// parameters
////      lIndex              読み込むUserSettingインデックス
////      pszChpInsPage       ChapterInsPageの格納先
////      size                ChapterInsPageのsize
////
//// return value
////      成功 : TRUE
////      失敗 : FALE
...
//			// _/_/_/  レジストリに保存しなおす
//			// ================================================
//			WriteData(NULL, preset, i, (long)dwID);
//
//			WriteEachData(preset, (long)dwID);
//
...
////
//// outline
////      指定されたUserSetting情報を指定のIDでレジストリに
////      書き込む
////=============================================================================
//long CShJsonUS::WriteEachData(PSCDM pscdm, long lID)
//{
//	long			lRet = -1;
//
//	DWORD			dwData = 0;
...
//	{
//		if((*m_pmcf).GetLong(MCF_SEC_PRNOPTONS, MCF_KEY_PRNOPT_SUP_US_EACHDATA, 1) == 0)
//			goto EXIT;
//	}
//
//	if(pscdm == NULL)
...
////
//// parameters
////      pscdm               読み込むSCDM構造体アドレス
////      dwID                読み込むID
////      pwReset             リセットするメンバのリスト(要するに読み込まない)
////
//// return value
////      成功 : 書き込んだID
////      失敗 : -1
////
//// outline
////      指定されたUserSetting情報を指定のIDでレジストリから
////      読み込む
////=============================================================================
...
//// parameters
////      dwID                読み込むID
////      pusul               リセットするメンバのリスト(要するに読み込まない)
////
//// return value
////      必要なメモリのサイズ
////
...
////
//// outline
////      USUPDATELISTのリスト内に指定の情報が存在するかどうかを取得する
////=============================================================================
...
////
//// outline
////      USUPDATELISTのリストの情報をレジストリに反映する
////=============================================================================
...
////
//// outline
////      指定されたUserSetting情報ファイルをレジストリに登録する
////=============================================================================
...
////	FILE			*pfSrc = NULL;
////	FILE			*pfDst = NULL;
////	errno_t			errSrc;				// fopen_s の戻り値を入れる
////	errno_t			errDst;				// fopen_s の戻り値を入れる
////
////	WCHAR			*p = NULL;
////	WCHAR			*p2 = NULL;
////	WCHAR			*p3 = NULL;
...
////
//// parameters
////      pszDateTime         YYYYMMDDHHmmSS 形式の日時文字列を格納するためのバッファー
////      dwBufSize           バッファーサイズ
////
//// return value
////      成功 : TRUE
...
////
//// outline
////      User Setting 0のベースとなったファイルの更新時刻を読み込む
////=============================================================================
...
////
//// outline
////      User Setting 0のベースとなったファイルの更新時刻を書き込む
////=============================================================================
...
////
//// outline
////      User Setting 0のベースとなったLCIDを書き込む
////=============================================================================
...
//		if(WriteData(pszTitle, pscdm,dwIndex,bOverWrite, pszTime, FALSE) == -1)
//			goto EXIT;
//
